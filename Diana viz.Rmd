...
anova(mod_1,mod_2) # Model 2 significant
...
```{r}
anova(mod_7,mod_8) # Model 8 significant
anova(mod_6,mod_7) # Model 7 significant
anova(mod_5,mod_6) # Model 5 significant

anova(mod_8, mod_9) # this has the standerdized scores
```
...
anova(mod_11,mod_12) # Model 12 significant
anova(mod_10,mod_11) # Model 10 significant

anova(mod_13, mod_14) # this has the standerdized scores
```
