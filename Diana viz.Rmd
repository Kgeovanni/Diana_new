...
## Tidy all_data
all_data df includes all 58 participants, two groups. Only total correct responses are included for each experimental task (flanker, stroop, backward).Including the kbzo0 who was later removed.
```{r message=FALSE, warning=FALSE , include=FALSE,echo =TRUE}
#Load working data
...
#background_survey_1$Experience = gsub(" years","",background_survey_1$Experience)

#library(stringr)
#str_remove_all(background_survey_1$Experience, " years")

#reorder(background_survey_1$Experience,as.numeric(gsub("-\\d+","",background_survey_1$Experience)))
