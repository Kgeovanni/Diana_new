...
```{r}
m1 = lm(stroop_correct ~ Bilingual + age + IQ, final_df)
summary(m1) # 0.003503
...
m2 = lm(stroop_correct ~ Bilingual * age * IQ, final_df)
summary(m2) # 0.02313
...
```{r}
m4 = lm(flanker_correct ~ Bilingual + age + IQ, final_df)
summary(m4)
...
m5 = lm(flanker_correct ~ Bilingual * age * IQ, final_df)
summary(m5)
...
anova_table2 = tidy(anova_results1)
print(anova_table2)
...
```{r}
m7 = lm(backward_correct ~ Bilingual + age + IQ, final_df)
summary(m7)
...
m8 = lm(backward_correct ~ Bilingual * age * IQ, final_df)
summary(m8)
